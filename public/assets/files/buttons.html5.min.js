(function(e) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(i) { return e(i, window, document) }) : "object" === typeof exports ? module.exports = function(i, l, t, s) { i || (i = window); if (!l || !l.fn.dataTable) l = require("datatables.net")(i, l).$;
        l.fn.dataTable.Buttons || require("datatables.net-buttons")(i, l); return e(l, i, i.document, t, s) } : e(jQuery, window, document) })(function(e, i, l, t, s, q) {
    function y(a) {
    ...
    function z(a, b) {
        ...
        e.each(b, function(d, c) {
            if (e.isPlainObject(c)) { var b = a.folder(d);
                z(b, c) } else {
                if (u) {
    ...
    function o(a, b, d) { var c = a.createElement(b);
        d && (d.attr && e(c).attr(d.attr), d.children && e.each(d.children, function(a, b) { c.appendChild(b) }), null !== d.text && d.text !== q && c.appendChild(a.createTextNode(d.text))); return c }
    ...
    if ("undefined" === typeof f || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) r =
        ...
        var w = f.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            ...
            E = function(a, b, d) {
                ...
                c.readyState = c.INIT;
                if (K) e = (f.URL || f.webkitURL || f).createObjectURL(a), setTimeout(function() { w.href = e;
                    ...
                    var g =
                        new FileReader;
                    g.onloadend = function() { var a = B ? g.result : g.result.replace(/^data:[^;]*;/, "data:attachment/file;");
    ...
    p.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            if (l.queryCommandSupported("copy")) { d.appendTo(b.table().container());
                ...
                c[0].select(); try { var k = l.execCommand("copy");
                    d.remove(); if (k) { b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, a.rows), 2E3);
                        this.processing(!1); return } } catch (o) {} }
            ...
            var j = e(k).closest(".dt-button-info"),
                n = function() { j.off("click.buttons-copy");
                    e(l).off(".buttons-copy");
                    b.buttons.info(!1) };
            j.on("click.buttons-copy", n);
            e(l).on("keydown.buttons-copy", function(a) { 27 === a.keyCode && (n(), f.processing(!1)) }).on("copy.buttons-copy cut.buttons-copy", function() { n();
                f.processing(!1) })
        },
        exportOptions: {},
        fieldSeparator: "\t",
    ...
    p.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, c) { this.processing(!0);
            ...
            d = c.charset;
            c.customize && (a = c.customize(a, c));!1 !== d ? (d || (d = l.characterSet || l.charset), d && (d = ";charset=" + d)) : d = "";
            c.bom && (a = "﻿" + a);
    ...
    p.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            var f = this,
                ...
                l, p, j = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        a[b] = e.trim(a[b]);
                        for (var j =
                                0, n = I.length; j < n; j++) { var m = I[j]; if (a[b].match && !a[b].match(/^0\d+/) && a[b].match(m.match)) { f = a[b].replace(/[^\d\.\-]/g, "");
                                m.fmt && (f = m.fmt(f));
                                f = o(g, "c", { attr: { r: i, s: m.style }, children: [o(g, "v", { text: f })] }); break } }
            ...
            var n = function(a, b) { var c = e("mergeCells", g);
            ...
            z(d, a);
            d.generateAsync ? d.generateAsync(b).then(function(a) { r(a, m.filename);
                f.processing(false) }) : (r(d.generate(b), m.filename), this.processing(!1))
        },
        filename: "*",
        extension: ".xlsx",
        exportOptions: {},
