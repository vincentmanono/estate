                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <p>
                                        ...
                                        excepted) to
                                        occupy  said Premises, or any portion thereof, without first obtaining the
                                        written consent
                                        of Landlord such consent shall not be unreasonably withheld. A consent by
                                        Landlord to any
                                        assignment, subletting, occupation  by any other person shall not be
                                        deemed to be a
                                        consent to any subsequent assignment, subletting, occupation  by any other
                                        person. Consent
                                    ...
                                    <p>
                                        {{ $lease->user->name }}) <br>
                                        This day of {{  $lease->created_at->format("d-M-Y") }}) TENANT <br>
                                        Signature  <img src="http://localhost:8000/signature/5fc2b5e9373eb.png" alt="">

                                        <br>
                                        ID NO {{ $lease->user->name }})
