                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> @if ($params == 'Add Lease Record')
                                   {{$params}}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-success" >
                                                ...
                                                <select class="form-control custom-select" name="unit_id" data-placeholder="Choose a Category" tabindex="1">
                          ...
                          @elseif($params =='Edit Lease Record')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-success" >
                                                ...
                                                <select class="form-control custom-select"  name="user_id" data-placeholder="Choose a Category" tabindex="1">
                                                    ...
                                                    <option value="{{ $lease->user->id }}" selected>{{ $lease->user->name }}</option>
                                                    @foreach ($users as $user)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-success" >
                                                ...
                                                <select class="form-control custom-select" name="unit_id" data-placeholder="Choose a Category" tabindex="1">
                                                    ...
                                                    <option value="{{ $lease->unit->id }}" selected>{{ $lease->unit->name }}</option>
                                                    @foreach ($units as $unit)
                                                         <option value="{{$unit->id}}">{{$unit->name}}</option>
                                                    @endforeach
                                                </select>
