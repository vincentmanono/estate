            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">SIngle Branch</h4>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div style="float: left">
                                    <h5 class="card-title">{{ $branch->name }} Properties Overview</h5>

                                </div>
                                <div style="float: right">
                                    <a class="btn btn-sm btn-primary" href="{{ route('allBranches') }}">Back</a>
                                </div>
