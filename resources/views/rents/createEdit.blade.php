        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a type="button" href="{{ route('rent.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New</a>
                    @endif
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route('rent.index') }}" type="button" class="btn btn-dark">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                  ...
                                  <form action="{{ route('rent.update',$rent->id) }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group has-success">
                                                        ...
                                                        <select  name="unit_id" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                            ...
                                                            <option value="{{ $rent->unit->id }}" selected>{{$rent->unit->name}}</option>
                                                            @foreach ($units as $unit)
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group has-success">
                                                        ...
                                                        <select  name="user_id" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                            ...
                                                            <option value="{{ $rent->user->id }}" selected>{{$rent->user->name}}</option>
                                                            @foreach ($tenants as $tenant)
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group has-success">
                                                        <label class="control-label">Amount</label>
                                                        <input type="type" value="{{ $rent->amount }}" name="amount" class="form-control">
                                                        </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                   <div class="form-group has-success">
                                                        <label class="control-label">Description</label>
                                                        <textarea type="text" rows="6" name="description"  class="form-control">{{ $rent->description }}</textarea>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div>
